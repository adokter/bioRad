...
#' \item \link{VP}: example object of class \link[=summary.vp]{vp} as generated by \link{calculate_vp}.
#' \item \link{VPTS}: example object of class \link[=summary.vpts]{vpts}.
#' \item \code{profile.h5}: example hdf5 file containing a vertical profile generated by \link{calculate_vp}. Locate this file in your local installation with \code{system.file("extdata", "profile.h5", package="bioRad")}. Read it with \link{readvp}.
...
#' \item \code{VPTable.txt}: example standard output of \link{calculate_vp} piped to a text file. Locate this file in your local installation with \code{system.file("extdata", "VPtable.txt", package="bioRad")}. Read it with \link{readvp.table}.
#' }
#' }
#'
#' @references
