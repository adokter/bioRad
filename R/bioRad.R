...
#' \item \code{vpts.txt}: example standard output of \link{calculate_vp} piped to a text file. Locate this file in your local installation with \code{system.file("extdata", "vpts.txt", package = "bioRad")}. Read it with \link{\code{read_vpts}}.
#' }
#' }
#'
#' @references
