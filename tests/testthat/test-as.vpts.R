...
test_that("as.vpts() returns 'DBZH' or 'dbz_all' based on from_csv argument", {
  ...
  expect_true(!"DBZH" %in% colnames(vpts_from_csv))
  expect_true("dbz_all" %in% colnames(vpts_from_csv))
