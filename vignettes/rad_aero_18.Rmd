...
_These course materials were developed for the 2nd Radar Aeroecology Training School, Aug 14-17 2018, University of Oklahoma, Norman, OK, USA._
...
**Exercise 2:** This case contains convective precipitation, characterised by localized but intense thunderstorms, as well as biological scattering. Make also a ppi plot of the radial velocity and correlation coefficient. Verify how the texture of the radial velocity, and the values of correlation coefficient of the precipitive areas differs from the areas with biological scattering.
...
**Exercise 4:** Plot the same ppi but now using a cartographic map instead of satellite maps as baselayer. See help of bioRad's `map()` function for available types of basemaps, specifically the argument `maptype`.
