...
* [Correct radar images for range effects](https://adokter.github.io/bioRad/dev/articles/range_correction.html)
...
<details>
<summary><strong>Required system libraries on Linux (Ubuntu)</strong></summary>

These system libraries are required before installing bioRad:
