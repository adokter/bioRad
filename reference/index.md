...
- [`download_pvolfiles()`](http://adriaandokter.com/bioRad/reference/download_pvolfiles.md)
  :
...
- [`get_iris_raw_task()`](http://adriaandokter.com/bioRad/reference/get_iris_raw_task.md)
  :
...
- [`write_pvolfile()`](http://adriaandokter.com/bioRad/reference/write_pvolfile.md)
  :

  Write a polar volume (`pvol`) object to ODIM HDF5 file

- [`summary(`*`<pvol>`*`)`](http://adriaandokter.com/bioRad/reference/summary.pvol.md)
  [`is.pvol()`](http://adriaandokter.com/bioRad/reference/summary.pvol.md)
  [`dim(`*`<pvol>`*`)`](http://adriaandokter.com/bioRad/reference/summary.pvol.md)
  :
...
- [`summary(`*`<scan>`*`)`](http://adriaandokter.com/bioRad/reference/summary.scan.md)
  [`is.scan()`](http://adriaandokter.com/bioRad/reference/summary.scan.md)
  [`dim(`*`<scan>`*`)`](http://adriaandokter.com/bioRad/reference/summary.scan.md)
  :
...
- [`summary(`*`<param>`*`)`](http://adriaandokter.com/bioRad/reference/summary.param.md)
  [`is.param()`](http://adriaandokter.com/bioRad/reference/summary.param.md)
  :
...
Functions to manipulate radar images (scan, param, ppi) and to identify
precipitation.
...
- [`calculate_param()`](http://adriaandokter.com/bioRad/reference/calculate_param.md)
  : Calculate a new scan parameter

- [`add_param()`](http://adriaandokter.com/bioRad/reference/add_param.md)
  : Add scan parameter from a georeferenced raster.

- [`apply_mistnet()`](http://adriaandokter.com/bioRad/reference/apply_mistnet.md)
  : Apply MistNet segmentation to a polar volume

- [`select(`*`<scan>`*`)`](http://adriaandokter.com/bioRad/reference/tidyverse.md)
  : Tidyverse methods for bioRad objects

- [`Math(`*`<scan>`*`)`](http://adriaandokter.com/bioRad/reference/Ops.md)
  [`Math(`*`<pvol>`*`)`](http://adriaandokter.com/bioRad/reference/Ops.md)
  [`Ops(`*`<param>`*`)`](http://adriaandokter.com/bioRad/reference/Ops.md)
  [`Ops(`*`<scan>`*`)`](http://adriaandokter.com/bioRad/reference/Ops.md)
  [`Ops(`*`<pvol>`*`)`](http://adriaandokter.com/bioRad/reference/Ops.md)
...
- [`scan_to_raster()`](http://adriaandokter.com/bioRad/reference/scan_to_raster.md)
...
- [`summary(`*`<ppi>`*`)`](http://adriaandokter.com/bioRad/reference/summary.ppi.md)
  [`is.ppi()`](http://adriaandokter.com/bioRad/reference/summary.ppi.md)
  [`dim(`*`<ppi>`*`)`](http://adriaandokter.com/bioRad/reference/summary.ppi.md)
  :
...
- [`check_docker()`](http://adriaandokter.com/bioRad/reference/bioRad-deprecated.md)
  [`update_docker()`](http://adriaandokter.com/bioRad/reference/bioRad-deprecated.md)
  [`vol2bird_version()`](http://adriaandokter.com/bioRad/reference/bioRad-deprecated.md)
  [`download_basemap()`](http://adriaandokter.com/bioRad/reference/bioRad-deprecated.md)
...
- [`download_vpfiles()`](http://adriaandokter.com/bioRad/reference/download_vpfiles.md)
  **\[superseded\]** :
...
- [`read_cajun()`](http://adriaandokter.com/bioRad/reference/read_cajun.md)
  :

  Read a vertical profile (`vp`) from UMASS Cajun text file

- [`summary(`*`<vp>`*`)`](http://adriaandokter.com/bioRad/reference/summary.vp.md)
  [`is.vp()`](http://adriaandokter.com/bioRad/reference/summary.vp.md)
  [`dim(`*`<vp>`*`)`](http://adriaandokter.com/bioRad/reference/summary.vp.md)
  :
...
- [`list_vpts_aloft()`](http://adriaandokter.com/bioRad/reference/list_vpts_aloft.md)
  **\[superseded\]** :
...
Functions to combine vertical profiles (vp) into time series (vpts) and
to post-process, read, inspect and plot these.

- [`c(`*`<vp>`*`)`](http://adriaandokter.com/bioRad/reference/c.vp.md) :
...
- [`filter_precip()`](http://adriaandokter.com/bioRad/reference/filter_precip.md)
  : Posthoc precipitation filter

- [`clean_mixture()`](http://adriaandokter.com/bioRad/reference/clean_mixture.md)
...
- [`summary(`*`<vpts>`*`)`](http://adriaandokter.com/bioRad/reference/summary.vpts.md)
  [`print(`*`<vpts>`*`)`](http://adriaandokter.com/bioRad/reference/summary.vpts.md)
  [`is.vpts()`](http://adriaandokter.com/bioRad/reference/summary.vpts.md)
  [`dim(`*`<vpts>`*`)`](http://adriaandokter.com/bioRad/reference/summary.vpts.md)
...
- [`as.vp()`](http://adriaandokter.com/bioRad/reference/as.vp.md) :
...
vertically integrating profiles (vp or vpts) into an integrated profile
(vpi).
...
- [`plot(`*`<vpi>`*`)`](http://adriaandokter.com/bioRad/reference/plot.vpi.md)
  :

  Plot an integrated profile (`vpi`)

- [`summary(`*`<vpi>`*`)`](http://adriaandokter.com/bioRad/reference/summary.vpi.md)
  [`is.vpi()`](http://adriaandokter.com/bioRad/reference/summary.vpi.md)
  :
...
- [`rcs()`](http://adriaandokter.com/bioRad/reference/rcs.md) : Get
  radar cross section
- [`` `rcs<-`() ``](http://adriaandokter.com/bioRad/reference/rcs-set.md)
...
- [`` `sd_vvp_threshold<-`() ``](http://adriaandokter.com/bioRad/reference/sd_vvp_threshold-set.md)
...
- [`doy()`](http://adriaandokter.com/bioRad/reference/doy_noy.md)
  [`noy()`](http://adriaandokter.com/bioRad/reference/doy_noy.md) : Look
  up day of year (doy) or night of year (noy)
- [`attribute_table()`](http://adriaandokter.com/bioRad/reference/attribute_table.md)
...
- [`beam_profile_overlap()`](http://adriaandokter.com/bioRad/reference/beam_profile_overlap.md)
...
- [`nyquist_velocity()`](http://adriaandokter.com/bioRad/reference/nyquist_velocity.md)
  : Calculate Nyquist velocity for a given pulse repetition frequency
  (PRF)
- [`sunrise()`](http://adriaandokter.com/bioRad/reference/sunrise_sunset.md)
  [`sunset()`](http://adriaandokter.com/bioRad/reference/sunrise_sunset.md)
  : Calculate sunrise or sunset for a time and place
- [`convert_legacy()`](http://adriaandokter.com/bioRad/reference/convert_legacy.md)
