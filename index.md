...
project the data to a plan position indicator with
[`project_as_ppi()`](http://adriaandokter.com/bioRad/reference/project_as_ppi.md)
and plot the *radial velocity* of detected targets with
...
![](reference/figures/README-plot_ppi-1.png)
...
This type of data is [available as open data](https://aloftdata.eu) for
over 100 European weather radars.
...
Here we read an example time series, project it on a regular time grid
with
...
![](reference/figures/README-plot_vpts-1.png)
...
resulting in a dataframe with rows for datetimes and columns for
quantities. Here we plot the quantity *migration traffic rate* (column
...
![](reference/figures/README-plot_vpi-1.png)
