...
- New argument `cachedir` in
  [`map()`](http://adriaandokter.com/bioRad/reference/map.md) to set the
  location of the cache used by dependency package `ggspatial`
...
- New function
  [`as.vp()`](http://adriaandokter.com/bioRad/reference/as.vp.md) to
...
- New argument `zoomin` for function
  [`bioRad::map()`](http://adriaandokter.com/bioRad/reference/map.md) to
  increase basemap resolution
...
- Fixes cropping in
  [`map()`](http://adriaandokter.com/bioRad/reference/map.md) with
...
- [`download_basemap()`](http://adriaandokter.com/bioRad/reference/bioRad-deprecated.md)
  ...
  [`map()`](http://adriaandokter.com/bioRad/reference/map.md) now
...
- New function
  [`read_stdout()`](http://adriaandokter.com/bioRad/reference/read_stdout.md)
...
- New functions
  ...
  [`Ops.pvol()`](http://adriaandokter.com/bioRad/reference/Ops.md),[`Ops.scan()`](http://adriaandokter.com/bioRad/reference/Ops.md),[`Ops.param()`](http://adriaandokter.com/bioRad/reference/Ops.md):
...
- [`map()`](http://adriaandokter.com/bioRad/reference/map.md) bugfix for
  transparency ([\#438](https://github.com/adokter/bioRad/issues/438))
  and base layer
...
- [`regularize_vpts()`](http://adriaandokter.com/bioRad/reference/regularize_vpts.md)’s
...
- New functions
  [`noy()`](http://adriaandokter.com/bioRad/reference/doy_noy.md) and
  [`doy()`](http://adriaandokter.com/bioRad/reference/doy_noy.md) to
...
- Bugfix that fixes the mapping by
  [`map()`](http://adriaandokter.com/bioRad/reference/map.md) of
...
- Fix a bug in the color legend of
  [`map()`](http://adriaandokter.com/bioRad/reference/map.md) when
...
- Custom color scales in
  [`map()`](http://adriaandokter.com/bioRad/reference/map.md) and
...
- [`integrate_profile()`](http://adriaandokter.com/bioRad/reference/integrate_profile.md)’s
  default unit of interval argument has been changed to seconds
  ([\#234](https://github.com/adokter/bioRad/issues/234)).

- [`project_as_ppi()`](http://adriaandokter.com/bioRad/reference/project_as_ppi.md)’s
...
- [`calculate_vp()`](http://adriaandokter.com/bioRad/reference/calculate_vp.md)’s
