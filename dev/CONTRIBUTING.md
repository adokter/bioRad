...
First of all, thanks for considering contributing to bioRad! 👍 It’s
people like you that make it rewarding for us - the project
maintainers - to work on bioRad. 😊

bioRad is an open source project, maintained by people who care. We are
not directly funded to do so.

## Code of conduct

Please note that this project is released with a [Contributor Code of
Conduct](http://adriaandokter.com/bioRad/dev/CODE_OF_CONDUCT.md). By
...
Think bioRad is useful? Let others discover it, by telling them in
person, via Twitter or a blog post.

Using bioRad for a paper you are writing? Consider [citing
it](https://adokter.github.io/bioRad/authors.html).

### Ask a question ⁉️

Using bioRad and got stuck? Browse the
[documentation](https://adokter.github.io/bioRad) to see if you can find
a solution. Still stuck? Post your question as an [issue on
GitHub](https://github.com/adokter/bioRad/issues/new). While we cannot
...
Have an idea for a new bioRad feature? Take a look at the
[documentation](https://adokter.github.io/bioRad) and [issue
list](https://github.com/adokter/bioRad/issues) to see if it isn’t
included or suggested yet. If not, suggest your idea as an [issue on
GitHub](https://github.com/adokter/bioRad/issues/new). While we can’t
...
Using bioRad and discovered a bug? That’s annoying! Don’t let others
have the same experience and report it as an [issue on
GitHub](https://github.com/adokter/bioRad/issues/new) so we can fix it.
...
[This website](https://adokter.github.io/bioRad) is generated with
...
issue](https://github.com/adokter/bioRad/issues/new) and we can point
...
1.  Go to `R/` directory in the [code
    repository](https://github.com/adokter/bioRad).
...
Care to fix bugs or implement new functionality for bioRad? Awesome! 👏
Have a look at the [issue
list](https://github.com/adokter/bioRad/issues) and leave a comment on
...
1.  Fork [this repo](https://github.com/adokter/bioRad) and clone it to
...
2.  If you have forked and cloned the project before and it has been a
    ...
    to your clone by using `git pull upstream develop` (the branch we
    use for developing).
...
4.  Make your changes:
    ...
    - Do an `R CMD check` using `devtools::check()` and aim for 0 errors
      and warnings.
